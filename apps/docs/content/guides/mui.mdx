...
Wire `@lamstack/react-dialog`'s templates to MUI's own `Dialog`/`DialogTitle`/`DialogContent`/
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    ([view on GitHub](https://github.com/jakhang/lamstack/blob/main/apps/docs/components/mui-dialog-demo.tsx)):
...
`@lamstack/react-dialog`'s `DialogProps.onClose` (`(event, reason) => void` vs. `(result: R) =>

...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    ([view on GitHub](https://github.com/jakhang/omnireact/blob/main/apps/docs/components/shadcn-dialog-demo.tsx)):
        ...
        <div className="flex gap-1">
          {[1, 2, 3, 4, 5].map((star) => (
            <button key={star} onClick={() => setRating(star)}>
              <Star className={star <= rating ? 'fill-primary text-primary' : 'text-muted-foreground'} size={20} />
            </button>
          ))}
        </div>
        <DialogFooter>

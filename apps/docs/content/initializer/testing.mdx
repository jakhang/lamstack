...
covers the full matrix — parallel execution, `dependsOn` ordering, retry, timeout,
critical/non-critical failures, `condition`, cascade skipping, and cancellation — worth
reading if you need to test any of those edge cases in your own app.

...
([`packages/react-initializer/src/core`](https://github.com/jakhang/lamstack/blob/main/packages/react-initializer/src/core)
and
[`.../src/react/Initializer.test.tsx`](https://github.com/jakhang/lamstack/blob/main/packages/react-initializer/src/react/Initializer.test.tsx))
